...
#Splitting the data into (maybe random) test and train data
x_train, x_test, y_train, y_test = train_test_split(info, target, test_size = .1)
...
scores = cross_val_score(model, info, target, cv=folds, scoring = 'accuracy')
print(scores)